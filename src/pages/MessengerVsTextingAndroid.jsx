...
const steps = [
  {
    number: 1,
    image: "https://media.db.com/images/public/68d2c3d10887bbe5530210d6/55c23c1b6_generated_image.png",
    instruction: "Check the app icon — purple lightning bolt = Messenger, blue speech bubble = regular texting."
  },
  {
    number: 2,
    image: "https://media.db.com/images/public/68d2c3d10887bbe5530210d6/de4ec78e1_generated_image.png",
    instruction: "Look beside the text box — if you see emoji, GIF, and sticker buttons, you're in Messenger."
  },
  {
    number: 3,
    image: "https://media.db.com/images/public/68d2c3d10887bbe5530210d6/934337630_generated_image.png",
  ...
  {
    number: 4,
    image: "https://media.db.com/images/public/68d2c3d10887bbe5530210d6/ffef44a19_generated_image.png",
    instruction: "Check the send button — a thumbs-up icon means you're in Messenger."
  }
];

export default function MessengerVsTextingAndroid() {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-gray-600">
            For Android phones — follow these steps to find out which app you have open.
          </p>
        </div>
